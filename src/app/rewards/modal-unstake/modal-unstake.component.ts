...
export class ModalUnstakeComponent implements OnInit {
  ...
  setUnstakeAmount(amount: number | string) {
    ...
    this.newRewardPerWeek = this.stakedMPHBalance.minus(this.unstakeAmount).times(this.totalRewardPerSecond.div(this.totalStakedMPHBalance.minus(this.unstakeAmount))).times(weekInSeconds);
